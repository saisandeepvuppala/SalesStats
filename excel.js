...
function check_percentage(value1) {
 ...
 if (parseInt(value1) > 100 || parseInt(value1) < 0 ) {
		...
		if (value1 != "" && total.value != "") {
			document.getElementById("rentailpending").innerText = ((((parseInt(total.value))*(parseInt(value1)))/100)-(parseInt(currentretail.innerText))).toFixed(2);
			document.getElementById("totalpending").innerText = ((parseInt(total.value)-parseInt(currenttotal.innerText))).toFixed(2);
			document.getElementById("wholesalepending").innerText = ((((parseInt(total.value))*(parseInt(wholesalepercentage)))/100)-(parseInt(currentwholesale.innerText))).toFixed(2);
...
function check_totalvalue(totalamount) {
		...
		var currenttotal = document.getElementById("totalcurrentamount");
		if (value1 != "" && total != "") {
			document.getElementById("rentailpending").innerText = ((((parseInt(total))*(parseInt(value1)))/100)-(parseInt(currentretail.innerText))).toFixed(2);
			document.getElementById("totalpending").innerText = ((parseInt(total)-parseInt(currenttotal.innerText))).toFixed(2);
			document.getElementById("wholesalepending").innerText = ((((parseInt(total))*(parseInt(wholesalepercentage)))/100)-(parseInt(currentwholesale.innerText))).toFixed(2);
